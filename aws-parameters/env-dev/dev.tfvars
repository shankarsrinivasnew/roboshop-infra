parameters = [
  ...
  { name = "dev.frontend.catalogue_url", value = "http://catalogue-dev.sstech.store:8080/", type = "String"},
  { name = "dev.frontend.user_url", value = "http://user-dev.sstech.store:8080/", type = "String"},
  { name = "dev.frontend.cart_url", value = "http://cart-dev.sstech.store:8080/", type = "String"},
  { name = "dev.frontend.shipping_url", value = "http://shipping-dev.sstech.store:8080/", type = "String"},
  { name = "dev.frontend.payment_url", value = "http://payment-dev.sstech.store:8080//", type = "String"},
  ...
  { name = "dev.catalogue.mongo_url", value = "mongodb://mongodb-dev.sstech.store:27017/users", type = "String"},
  ...
  { name = "dev.user.mongo_url", value = "mongodb://mongodb-dev.sstech.store:27017/catalogue", type = "String"},
