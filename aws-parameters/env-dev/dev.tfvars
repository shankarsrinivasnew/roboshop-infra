parameters = [
  ...
  { name = "dev.shipping.cart_endpoint", value = "cart-dev.sstech.store:80", type = "String" },
...
secrets = [
  ...
  { name = "dev.rds_user", value = "admin1", type = "SecureString" },
  { name = "dev.rds_user", value = "RoboShop1", type = "SecureString" }
]
